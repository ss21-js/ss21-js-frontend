...
const ProfileHeaderSection: React.FC = () => {
	...
	return (
		<Container>
			<Header>
				<HeaderImage src={'https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80'} />
